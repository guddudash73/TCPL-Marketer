...
export class AuthService {
  ...
  async logout(token: string, principal: AuthPrincipal, context: RequestContext): Promise<void> {
...
function requestMetadata(context: RequestContext): Record<string, string> | undefined {
  const metadata = Object.fromEntries(
    Object.entries({ ipAddress: context.ipAddress, userAgent: context.userAgent }).filter(
